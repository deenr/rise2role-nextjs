...
const AlertDialogAction = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Action> & { variant?: 'default' | 'destructive' | 'secondary' }
>(({ className, variant, ...props }, ref) => <AlertDialogPrimitive.Action ref={ref} className={cn(buttonVariants({ variant: variant ?? 'default' }), className)} {...props} />);
